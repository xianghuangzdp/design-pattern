...
public class KingdomFactoryMarker {
    ...
    public static final Map<String, Supplier<KingdomFactory>> FACTORY_SUPPLIER_MAP = new HashMap<String, Supplier<KingdomFactory>>(){
        {
    ...
    public static KingdomFactory makeFactory(String type){
        if (FACTORY_SUPPLIER_MAP.containsKey(type)){
            return FACTORY_SUPPLIER_MAP.get(type).get();
        }
